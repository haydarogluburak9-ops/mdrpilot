...
export const OPERATIONAL_MODULES: Record<OperationalModuleSlug, OperationalModuleDef> = {
  ...
  calibration: {
    ...
    referenceAliases: ["ekipman no", "equipment no", "cihaz no", "device id", "referans no", "reference no"],
    titleAliases: ["ekipman adı", "equipment name", "ölçüm cihazı", "measuring device"],
    descriptionAliases: ["kalibrasyon notu", "calibration note", "açıklama", "description"],
    ownerAliases: ["sorumlu", "owner", "kalibrasyon sorumlusu", "calibration owner"],
    dueDateAliases: ["sonraki kalibrasyon", "next calibration", "hedef tarih", "target date"],
    capaRefAliases: ["capa no", "capa no."],
