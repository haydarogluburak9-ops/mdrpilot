...
export const SECTION_OUTLINES: Record<string, OutlineHeading[]> = {
  "device-description": [
    ...
    { en: "Materials and Components", tr: "Malzemeler ve Bileşenler" },
    { en: "Accessories and Configurations", tr: "Aksesuarlar ve Konfigürasyonlar" },
  ...
  "general-info": [
    ...
    { en: "EUDAMED Registration", tr: "EUDAMED Kaydı" },
    { en: "SRN and Economic Operators", tr: "SRN ve Ekonomik Operatörler" },
  ],
  "previous-generations": [
    { en: "Previous Generations by the Manufacturer", tr: "Üreticinin Önceki Nesilleri" },
    { en: "Similar Devices on the Market", tr: "Pazardaki Benzer Cihazlar" },
  ...
  "info-supplied": [
    ...
    { en: "Packaging Information", tr: "Ambalaj Bilgileri" },
  ],
